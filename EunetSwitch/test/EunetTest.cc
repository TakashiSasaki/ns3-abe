...
void EunetTestCase::DoRun() {
	...
	auto t113 = ptr_s11->eunetTerminals.Get(3)->GetObject<EunetTerminal> ();
	auto t125 = ptr_s12->eunetTerminals.Get(5)->GetObject<EunetTerminal> ();
	t113->setRemote(t125->getAddress<ns3::CsmaNetDevice> (0));
	...
	Simulator::Run();
	Simulator::Destroy();
	NS_ASSERT_MSG(t113->getTotalRx() == 0, t113->getTotalRx());
	NS_ASSERT_MSG(t125->getTotalRx() == 342016, t125->getTotalRx());
}
