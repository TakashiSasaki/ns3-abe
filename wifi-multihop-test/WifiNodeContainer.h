...
private:
	...
	virtual void receiveOkCallback(ns3::Ptr<ns3::Packet> ptr_packet, double snr, ns3::WifiMode wifi_mode, enum ns3::WifiPreamble wifi_preamble);
	virtual void receiveErrorCallback(ns3::Ptr<const ns3::Packet> ptr_packet, double snr);
};//WifiNodeContainer
}//abe
